...
public final class Ty {
  ...
  public final Ty elem; // element type
  public final int[] dims; // dimensions
  ...
  /** "const int[3][4]" -> Ty.array(INT, 3, 4) + isConst flag */
